...
#import "UIDraggableCollectionView.h"
...
@interface UIDraggableCollectionView ()
...
@implementation UIDraggableCollectionView
...
- (void)longPressGestureRecognized:(id)sender {
    ...
    id <UIDraggableCollectionViewDelegate> delegate = (id <UIDraggableCollectionViewDelegate>)self.delegate;
    BOOL canMove = NO;
    if ([delegate respondsToSelector:@selector(collectionView:canMoveAtIndexPath:)]){
       canMove = [delegate collectionView:self canMoveAtIndexPath:_relocatedIndexPath];
    }
...
- (void)updateDataSource {
    ...
    id <UIDraggableCollectionViewDelegate> delegate = (id <UIDraggableCollectionViewDelegate>)self.delegate;
    if ([delegate respondsToSelector:@selector(collectionView:moveItemFromIndexPath:toIndexPath:)]){
        [delegate collectionView:self moveItemFromIndexPath:_originalIndexPath toIndexPath:_relocatedIndexPath];
    }
}
